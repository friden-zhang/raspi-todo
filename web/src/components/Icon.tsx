...
// Static SVG icons to replace Lucide dynamic icons
const icons: Record<string, string> = {
  ...
  'check-square':
    '<path d="M9 11l3 3L20 4"/><path d="M21 12v7a2 2 0 01-2 2H5a2 2 0 01-2-2V5a2 2 0 012-2h11"/>',
  'trash-2':
  ...
  'alert-triangle':
    '<path d="M21.73 18L13.73 4a2 2 0 0 0-3.46 0l-8 14A2 2 0 0 0 4 21h16a2 2 0 0 0 1.73-3Z"/><line x1="12" x2="12" y1="9" y2="13"/><line x1="12" x2="12.01" y1="17" y2="17"/>',
  inbox:
    '<polyline points="22,12 16,12 14,15 10,15 8,12 2,12"/><path d="M5.45 5.11 2 12v6a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-6l-3.45-6.89A2 2 0 0 0 16.76 4H7.24a2 2 0 0 0-1.79 1.11z"/>',
  'clipboard-list':
    '<rect width="8" height="4" x="8" y="2" rx="1" ry="1"/><path d="M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2"/><path d="M12 11h4"/><path d="M12 16h4"/><path d="M8 11h.01"/><path d="M8 16h.01"/>',
  'list-todo':
    '<rect x="3" y="5" width="6" height="6" rx="1"/><path d="M8 11l2 2 4-4"/><path d="M3 17h18"/><path d="M3 21h18"/>',
...
export function Icon({
  ...
  const iconSvg = icons[name] || icons['help-circle'] // fallback icon
